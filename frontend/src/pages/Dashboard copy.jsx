// Contenido COMPLETO y ACTUALIZADO para: src/pages/Dashboard.jsx

import React from 'react';
import SubirCierre from '../components/SubirCierre';
// Importamos el nuevo componente que acabamos de crear
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        {/* Columna secundaria con la actividad reciente y alertas */}
        <div className="lg:col-span-2 space-y-6">
            
            {/* AQUÍ OCURRE EL CAMBIO: Usamos el nuevo componente */}
            <ActividadReciente />
